...
export default function Profile({ profileUserId: propProfileUserId }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 text-black font-sans antialiased pb-20 selection:bg-black selection:text-white transition-opacity duration-300 ease-in-out opacity-100">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                        {isOwnProfile && !isEditing && (
                            <button
                                ...
                                className="px-3 sm:px-4 py-2 rounded-xl border border-gray-300 bg-white hover:bg-gray-50 text-black text-xs font-bold flex items-center space-x-1.5 sm:space-x-2 transition duration-200 ease-in-out hover:scale-[1.02] shadow-xs cursor-pointer"
                            >
                        ...
                        {isOwnProfile && (
                            <button
                                ...
                                className="px-3 sm:px-4 py-2 rounded-xl border border-rose-200 bg-rose-50 hover:bg-rose-100 text-rose-700 text-xs font-bold flex items-center space-x-1.5 sm:space-x-2 transition duration-200 ease-in-out hover:scale-[1.02] cursor-pointer"
                            >
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 mt-6 sm:mt-8 space-y-6">
                ...
                {/* Toast Notification */}
                {saveSuccess && (
                    <div className="bg-gray-900 text-white px-4 sm:px-5 py-3.5 rounded-2xl flex items-center justify-between text-xs font-bold shadow-lg transition-all duration-300 ease-in-out animate-in fade-in slide-in-from-top-2">
                        ...
                        <button onClick={() => setSaveSuccess(false)} className="cursor-pointer shrink-0">
                            <X className="w-4 h-4 text-gray-400 hover:text-white transition-colors duration-150" />
                        </button>
                    </div>
                )}

                {/* Hero Header Card */}
                <section className="bg-white rounded-3xl border border-gray-200 p-5 sm:p-8 shadow-sm relative overflow-hidden transition-all duration-300 ease-in-out hover:shadow-md">
                    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6">
                        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-5 sm:gap-6 w-full">
                            ...
                            <div className="relative group shrink-0">
                                <img
                                    ...
                                    alt={profile.name}
                                    className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover ring-4 ring-gray-100 shadow-md transition-transform duration-300 group-hover:scale-105"
                                />
                                {isEditing && (
                                    <div className="absolute inset-0 bg-black/60 rounded-2xl flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-200 ease-in-out">
                            ...
                            <div className="space-y-2 w-full">
                                <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-2 sm:gap-3">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider border shrink-0 transition-colors duration-200 ${
                                        isProfessional 
                        ...
                        {isProfessional && (
                            <div className="w-full lg:w-auto bg-gray-50 rounded-2xl border border-gray-200 p-4 flex flex-row lg:flex-col items-center justify-between gap-3 text-left lg:text-right shrink-0">
                                ...
                                <button className="px-5 py-2.5 bg-black hover:bg-gray-800 text-white rounded-xl text-xs font-bold transition duration-200 ease-in-out hover:scale-[1.02] active:scale-[0.98] shadow-xs cursor-pointer w-auto lg:w-full">
                                    Book Session
                                </button>
                            </div>
                        )}
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                    <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-xs transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                    ...
                    {isProfessional ? (
                        ...
                        <>
                            <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-xs col-span-2 sm:col-span-1 lg:col-span-2 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                ...
                <form onSubmit={handleSaveProfile} className="space-y-6">
                    ...
                    {/* Bio Section */}
                    <div className="bg-white border border-gray-200 rounded-3xl p-5 sm:p-8 space-y-4 shadow-xs transition-all duration-300 ease-in-out hover:shadow-md">
                        ...
                        {isEditing ? (
                            <textarea
                                ...
                                className="w-full bg-gray-50 border border-gray-300 rounded-xl p-3 text-xs text-black font-medium focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {isProfessional && (
                            <>
                                <div className="bg-white border border-gray-200 rounded-3xl p-5 sm:p-6 space-y-4 shadow-xs transition-all duration-300 ease-in-out hover:shadow-md">
                                    <h3 className="text-xs font-black uppercase tracking-wider text-black flex items-center space-x-2">
                                    ...
                                    {isEditing ? (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-gray-50 border border-gray-300 rounded-xl p-3 text-xs font-bold text-black focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200"
                                            />
                                        </div>
                                    ) : (
                                ...
                                <div className="bg-white border border-gray-200 rounded-3xl p-5 sm:p-6 space-y-4 shadow-xs transition-all duration-300 ease-in-out hover:shadow-md">
                                    ...
                                    {isEditing ? (
                                        <div className="space-y-3">
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 min-w-0 bg-gray-50 border border-gray-300 rounded-xl p-2.5 text-xs text-black font-medium focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200"
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => handleAddTag('languages')}
                                                    className="px-3.5 bg-black text-white hover:bg-gray-800 rounded-xl text-xs font-bold cursor-pointer shrink-0 transition duration-200 ease-in-out hover:scale-[1.02] active:scale-[0.98]"
                                                >
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {profile.languages.map((lang, idx) => (
                                                    <span key={idx} className="px-3 py-1 bg-gray-100 border border-gray-300 rounded-xl text-xs font-bold text-black flex items-center gap-1.5 break-all transition-transform duration-150 hover:scale-[1.02]">
                                                        {lang}
                                                        <button type="button" onClick={() => handleRemoveTag('languages', idx)} className="cursor-pointer shrink-0">
                                                            <Trash2 className="w-3.5 h-3.5 text-gray-500 hover:text-black transition-colors duration-150" />
                                                        </button>
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {profile.languages.map((lang, idx) => (
                                                <span key={idx} className="px-3 py-1.5 bg-gray-100 border border-gray-300 rounded-xl text-xs font-bold text-black break-all transition-transform duration-150 hover:scale-[1.02]">
                                                    {lang}
                                                </span>
                                            ))}
                                        </div>
                    ...
                    {/* Form Controls */}
                    {isEditing && (
                        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4 transition-all duration-200">
                            <button
                                type="button"
                                onClick={() => setIsEditing(false)}
                                className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 text-xs font-bold transition duration-200 ease-in-out hover:scale-[1.02] cursor-pointer"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                disabled={saving}
                                className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-black hover:bg-gray-800 text-white text-xs font-bold flex items-center justify-center space-x-2 transition duration-200 ease-in-out hover:scale-[1.02] active:scale-[0.98] shadow-md cursor-pointer"
                            >
            ...
            {showLogoutModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs transition-opacity duration-300 ease-in-out animate-in fade-in">
                    <div className="bg-white border border-gray-200 rounded-3xl max-w-sm w-full p-6 shadow-2xl space-y-5 transition-all duration-300 ease-out animate-in zoom-in-95">
                        ...
                        <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-2 sm:gap-3 pt-2">
                            <button
                                ...
                                className="w-full sm:w-auto px-4 py-2.5 rounded-xl border border-gray-300 text-gray-700 hover:bg-gray-100 text-xs font-bold transition duration-200 ease-in-out hover:scale-[1.02] cursor-pointer"
                            >
                                Cancel
                            </button>
                            <button
                                onClick={handleConfirmLogout}
                                className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold transition duration-200 ease-in-out hover:scale-[1.02] active:scale-[0.98] shadow-sm cursor-pointer"
                            >
                                Confirm Sign Out
                            </button>
                        </div>
